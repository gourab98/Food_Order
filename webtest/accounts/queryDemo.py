...
customerByName = Customer.objects.get(name='Apu')
...
'''
Q: If the customer has more than 1 Football, how would you reflect it in the database?
...
ballOrders = firstCustomer.order_set.filter(product__name="Football").count()
